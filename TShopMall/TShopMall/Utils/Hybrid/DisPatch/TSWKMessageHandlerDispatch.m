...
@interface TSWKMessageHandlerDispatch()

@property (nonatomic, strong) NSMutableDictionary *cachedTarget;

@end

@implementation TSWKMessageHandlerDispatch

+ (instancetype)sharedInstance {
    static TSWKMessageHandlerDispatch *dispatch = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        dispatch = [[TSWKMessageHandlerDispatch alloc] init];
    });
    return dispatch;
}
