...
- (UIImageView *)icon {
    if (_icon == nil) {
        ...
        _icon = icon;
        NSString *imageFile = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"CMPhotoSelector.bundle/selected@2x.png"];
        _icon.image = [UIImage imageWithContentsOfFile:imageFile];
