...
static const CGFloat DefaultElementHeight = 174.0; // 默认高度
...
- (void)setModel:(BasicDialogModel *)model {
    ...
    self.textView.textColor = [UIColor colorWithHexString:textColor];
    self.textView.placeholder = textViewModel.placeHolderContent;
    self.textView.placeholderColor = [UIColor colorWithHexString:PlaceHolderColor];
    ...
    if (textViewModel.tintColor.length > 0) {
        self.textView.tintColor = [UIColor colorWithHexString:textViewModel.tintColor];
    }
...
- (UITextView *)textView {
    if (!_textView) {
        ...
        _textView.backgroundColor = [UIColor colorWithHexString:@"#ECECEC"];
    }
    return _textView;
}
...
- (UILabel *)maxLengthLabel {
    if (!_maxLengthLabel) {
        ...
        _maxLengthLabel.textColor = [UIColor colorWithHexString:@"#662D3132"];
        _maxLengthLabel.font = [UIFont systemFontOfSize:14];
