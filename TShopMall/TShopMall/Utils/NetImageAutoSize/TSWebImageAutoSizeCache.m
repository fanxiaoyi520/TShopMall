...
@interface TSWebImageAutoSizeCache()
...
@implementation TSWebImageAutoSizeCache

+(TSWebImageAutoSizeCache *)shardCache{
    
    static TSWebImageAutoSizeCache *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        
        instance = [[TSWebImageAutoSizeCache alloc] init];
...
#pragma mark - TSWebImageAutoSizeCache (private)
