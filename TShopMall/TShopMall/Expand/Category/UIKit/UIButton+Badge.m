...
- (void)badgeInit {
    ...
    self.badgePadding = 0.0;
    self.badgeMinSize = 15;
    //    self.badgeOriginX   = self.badge.frame.size.width * 0.5 + self.badgeMinSize * 0.5 + 20 * 0.5;
    //    self.badgeOriginY   = self.badge.frame.size.height * 0.5 + self.badgeMinSize * 0.5 - 24 * 0.5;
...
- (void)updateBadgeFrame {
    ...
    CGFloat minWidth = expectedLabelSize.width + 4;
...
+ (instancetype)buttonWithBadgeTextColor:(UIColor *)badgeTextColor
    ...
    button.badgeBGColor = badgeBackGroundColor;
    button.badgeTextColor = badgeTextColor;
    button.badgeOriginX = 30 - 15 * 0.5;
    ;
    button.badgeOriginY = -2;
    return button;
}
